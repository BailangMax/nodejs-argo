...
const UUID = process.env.UUID || '52241ea5-a48b-4c41-af6a-20079dbe0e38'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'holoy.qzz.io';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || '50b2c226-89bd-4162-b1ae-ce997708e94f.holoy.qzz.io';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
