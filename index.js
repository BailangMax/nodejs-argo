...
const UUID = process.env.UUID || '9c9a4374-2c6b-493d-8b77-b346732697a5'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_PORT = process.env.ARGO_PORT || 2531;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
