...
const UUID = process.env.UUID || 'ac345af6-a9a7-4d99-a972-a1ee808e1861'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_PORT = process.env.ARGO_PORT || 8035;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
